...
- **EV 车辆清单**：`../Data/.../EV_UK_LSOA_2025_with_energy.csv`（1.58M 行，按 LSOA 的 EV 计数）。关键列：`LSOA_code, Model, count, Energy_kWh, DC_Power_kW, AC_Power_kW, efficiency_wh_per_km, vehicle_subtype`。
